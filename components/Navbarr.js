...
const Navbarr = () => {
  ...
  const navLinks = [
    ...
    { href: "/admin/visitor-profile", label: "Visitor Profile", icon: "M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" },
    { href: "/admin/addVisitor", label: "Add Visitor", icon: "M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z" },
    ...
    { href: "/admin/logs", label: "System Logs", icon: "M9 5H7a2 2 0 00-2 2v12a2 2 0 002 2h10a2 2 0 002-2V7a2 2 0 00-2-2h-2M9 5a2 2 0 002 2h2a2 2 0 002-2M9 5a2 2 0 012-2h2a2 2 0 012 2" },
  ...
  const filteredLinks = navLinks.filter(({ href }) => {
    ...
    if (href === "/admin/logs") return username === "admin" || ["MKulkarni", "Deshmukh"].includes(username) || allowedPages.includes("/admin/logs");
    if (username === "admin") return true;
    if (href === "/admin/workers" || href === "/admin/addWorker") return false;
    if (href === "/admin") return true;
    if (href === "/admin/search") return true;
    if (href === "/admin/visitorTable" || href === "/admin/visitor-profile" || href === "/admin/addVisitor") return allowedPages.includes("/admin/visitorTable");
