...
/* ─── Admin Inward Letters List Page ────────────────────────── */
export default function InwardLettersListAdmin() {
  ...
  return (
    <>
      <Head>
        <title>Manage Inward Letters – Saheb Inward letters</title>
        <meta name="description" content="View and manage all registered inward letters." />
      </Head>
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-8 py-6 md:py-10 space-y-6">
        ...
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-3">
          <div>
            <h1 className="text-2xl md:text-3xl font-extrabold text-slate-800">Inward Letters Registry</h1>
            <p className="text-slate-500 text-sm mt-1">
              Total {total} inward letters registered across all accounts.
            </p>
          </div>
          <div className="flex gap-2.5">
            ...
            <button
              onClick={() => router.push("/admin/addInwardLetter")}
                    ...
                    <tr key={l._id} className="hover:bg-orange-50/20 transition-colors">
                      ...
                      <td className="px-4 py-3">
                        <div className="flex items-center gap-1.5">
                          ...
                          <button
                            onClick={() => router.push(`/admin/edit-inward-letter/${l._id}`)}
